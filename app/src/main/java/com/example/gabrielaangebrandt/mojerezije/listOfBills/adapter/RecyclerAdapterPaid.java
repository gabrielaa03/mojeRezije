...
public class RecyclerAdapterPaid extends com.bignerdranch.expandablerecyclerview.Adapter.ExpandableRecyclerAdapter<RecyclerAdapterPaid.TitleParentViewHolder, RecyclerAdapterPaid.TitleChildViewHolder> {

    List<Bill> bills = new ArrayList<>();
    LayoutInflater inflater;

    public RecyclerAdapterPaid(Context context, List<ParentObject> parentItemList) {
    ...
    public TitleParentViewHolder onCreateParentViewHolder(ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.layout_parent_green, viewGroup, false);
        return new TitleParentViewHolder(view);
    }

    @Override
    public TitleChildViewHolder onCreateChildViewHolder(ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.layout_child_green, viewGroup, false);
    ...
    public void addDataToAdapter(List<Bill> list) {
        bills.clear();
        bills.addAll(list);
